...
class ResponseMetricFacebook {
    ...
    factory ResponseMetricFacebook.fromRawJson(String str) => ResponseMetricFacebook.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory ResponseMetricFacebook.fromJson(Map<String, dynamic> json) => ResponseMetricFacebook(
...
class DataFacebook {
    ...
    factory DataFacebook.fromRawJson(String str) => DataFacebook.fromJson(json.decode(str));
    ...
    factory DataFacebook.fromJson(Map<String, dynamic> json) => DataFacebook(
        ...
        reachRatio: json["reach_ratio"],
        engagementPerPost: json["engagement_per_post"]?.toDouble(),
